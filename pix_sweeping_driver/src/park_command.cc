...
void ParkCommand::UpdateData(int check_sum_104, bool park_target, bool park_en_ctrl) {
  set_p_check_sum_104(check_sum_104);
...
// config detail: {'bit': 63, 'is_signed_var': False, 'len': 8, 'name': 'check_sum_104', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
void ParkCommand::set_p_check_sum_104(int check_sum_104) {
  // check_sum_104 = ProtocolData::BoundedValue(0, 255, check_sum_104);
  int x = check_sum_104;
  uint8_t a = 0;

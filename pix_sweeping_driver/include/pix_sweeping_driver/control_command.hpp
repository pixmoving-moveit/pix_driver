...
#include <pix_sweeping_driver_msgs/msg/acu_sweep_ctrl_cmd.hpp>
...
#include <pix_sweeping_driver/brake_command.hpp>
#include <pix_sweeping_driver/steering_command.hpp>
#include <pix_sweeping_driver/gear_command.hpp>
#include <pix_sweeping_driver/park_command.hpp>
...
private:
  ...
  rclcpp::Subscription<pix_sweeping_driver_msgs::msg::ThrottleCommand>::SharedPtr throttle_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::BrakeCommand>::SharedPtr brake_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::SteeringCommand>::SharedPtr steering_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::GearCommand>::SharedPtr gear_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::ParkCommand>::SharedPtr park_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::VehicleModeCommand>::SharedPtr vehicle_mode_command_sub_;
rclcpp::Subscription<pix_sweeping_driver_msgs::msg::AcuSweepCtrlCmd>::SharedPtr acu_sweep_ctrl_cmd_sub_;


  // msgs
  // example A2vBrakeCtrl::ConstSharedPtr brake_ctrl_ptr_;
  pix_sweeping_driver_msgs::msg::ThrottleCommand::ConstSharedPtr throttle_command_ptr_;
pix_sweeping_driver_msgs::msg::BrakeCommand::ConstSharedPtr brake_command_ptr_;
pix_sweeping_driver_msgs::msg::SteeringCommand::ConstSharedPtr steering_command_ptr_;
pix_sweeping_driver_msgs::msg::GearCommand::ConstSharedPtr gear_command_ptr_;
pix_sweeping_driver_msgs::msg::ParkCommand::ConstSharedPtr park_command_ptr_;
pix_sweeping_driver_msgs::msg::VehicleModeCommand::ConstSharedPtr vehicle_mode_command_ptr_;
pix_sweeping_driver_msgs::msg::AcuSweepCtrlCmd::ConstSharedPtr acu_sweep_ctrl_cmd_ptr_;
...
AcuSweepCtrlCmd acu_sweep_ctrl_cmd_entity_;
...
rclcpp::Time acu_sweep_ctrl_cmd_received_time_;
...
can_msgs::msg::Frame::ConstSharedPtr acu_sweep_ctrl_cmd_can_ptr_;
...
public:
  ...
  void callbackThrottleCommand(const pix_sweeping_driver_msgs::msg::ThrottleCommand::ConstSharedPtr & msg);

void callbackBrakeCommand(const pix_sweeping_driver_msgs::msg::BrakeCommand::ConstSharedPtr & msg);

void callbackSteeringCommand(const pix_sweeping_driver_msgs::msg::SteeringCommand::ConstSharedPtr & msg);

void callbackGearCommand(const pix_sweeping_driver_msgs::msg::GearCommand::ConstSharedPtr & msg);

void callbackParkCommand(const pix_sweeping_driver_msgs::msg::ParkCommand::ConstSharedPtr & msg);

void callbackVehicleModeCommand(const pix_sweeping_driver_msgs::msg::VehicleModeCommand::ConstSharedPtr & msg);

void callbackAcuSweepCtrlCmd(const pix_sweeping_driver_msgs::msg::AcuSweepCtrlCmd::ConstSharedPtr & msg);

...
Brakereport289::Brakereport289() {}
int32_t Brakereport289::ID = 0x289;

void Brakereport289::update_bytes(uint8_t bytes_data[8])
{
  for(uint i=0;i<8;i++)
  {
...
int Brakereport289::EBSMotAglFbk() {
  Byte t0(*(bytes + 6));
...
bool Brakereport289::EBSWarningLight() {
  Byte t0(*(bytes + 3));
...
int Brakereport289::EBSFaultInfo() {
  Byte t0(*(bytes + 4));
  int32_t x = t0.get_byte(0, 8);
...
bool Brakereport289::EBSExtBrkPrio() {
  Byte t0(*(bytes + 3));
...
bool Brakereport289::EBSDrvrInteraction() {
  Byte t0(*(bytes + 3));
...
bool Brakereport289::EBSBrkPedalAppliedV() {
  Byte t0(*(bytes + 3));
...
bool Brakereport289::EBSBrkPedalApplied() {
  Byte t0(*(bytes + 3));
...
bool Brakereport289::EBSBrakelight() {
  Byte t0(*(bytes + 1));
  int32_t x = t0.get_byte(2, 1);

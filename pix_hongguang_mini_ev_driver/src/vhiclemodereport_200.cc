...
Vhiclemodereport200::Vhiclemodereport200() {}
int32_t Vhiclemodereport200::ID = 0x200;

void Vhiclemodereport200::update_bytes(uint8_t bytes_data[8])
{
  for(uint i=0;i<8;i++)
  {
...
void Vhiclemodereport200::Parse() {
...
int Vhiclemodereport200::AutoCtrlStat() {
  Byte t0(*(bytes + 0));
...
int Vhiclemodereport200::ModeStatCnt() {
  Byte t0(*(bytes + 6));
...
int Vhiclemodereport200::ModeStatCks() {
  Byte t0(*(bytes + 7));

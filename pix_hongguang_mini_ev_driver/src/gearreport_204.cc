...
Gearreport204::Gearreport204() {}
int32_t Gearreport204::ID = 0x204;

void Gearreport204::update_bytes(uint8_t bytes_data[8])
{
  for(uint i=0;i<8;i++)
  {
...
int Gearreport204::TurnLightCmd() {
  Byte t0(*(bytes + 1));
  int32_t x = t0.get_byte(2, 2);
...
int Gearreport204::TurnLightAct() {
  Byte t0(*(bytes + 1));
  int32_t x = t0.get_byte(0, 2);
...
int Gearreport204::BeamLightAct() {
  Byte t0(*(bytes + 1));
...
int Gearreport204::BeamLightCmd() {
  Byte t0(*(bytes + 1));

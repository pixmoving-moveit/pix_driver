...
int32_t Gearcommand104::ID = 0x104;

// public
Gearcommand104::Gearcommand104() { Reset(); }

void Gearcommand104::UpdateData(int wipercmd_, bool horncmd_, int gearcmd_, bool gearctrlena_, int turnlightcmd_, int beamlightcmd_, int gearctrlcnt_, int gearctrlcks_) {
...
uint8_t * Gearcommand104::get_data()
{
  return data;
}
...
void Gearcommand104::set_p_wipercmd(int wipercmd) {
...
void Gearcommand104::set_p_horncmd(bool horncmd) {
  int x = horncmd;
  uint8_t a = 0;
...
void Gearcommand104::set_p_gearcmd(int gearcmd) {
...
void Gearcommand104::set_p_gearctrlena(bool gearctrlena) {
  int x = gearctrlena;
  uint8_t a = 0;
...
void Gearcommand104::set_p_turnlightcmd(int turnlightcmd) {
...
void Gearcommand104::set_p_beamlightcmd(int beamlightcmd) {
...
void Gearcommand104::set_p_gearctrlcnt(int gearctrlcnt) {
...
void Gearcommand104::set_p_gearctrlcks(int gearctrlcks) {

...
int32_t Vhiclemodecommand100::ID = 0x100;

// public
Vhiclemodecommand100::Vhiclemodecommand100() { Reset(); }

void Vhiclemodecommand100::UpdateData(bool autoctrlena_, int modectrlcnt_, int modectrlcks_) {
  set_p_autoctrlena(autoctrlena_);
  set_p_modectrlcnt(modectrlcnt_);
  set_p_modectrlcks(modectrlcks_);
}

void Vhiclemodecommand100::Reset() {
...
uint8_t * Vhiclemodecommand100::get_data()
{
  return data;
}
...
void Vhiclemodecommand100::set_p_autoctrlena(bool autoctrlena) {
  int x = autoctrlena;
  uint8_t a = 0;
...
void Vhiclemodecommand100::set_p_modectrlcnt(int modectrlcnt) {
...
void Vhiclemodecommand100::set_p_modectrlcks(int modectrlcks) {

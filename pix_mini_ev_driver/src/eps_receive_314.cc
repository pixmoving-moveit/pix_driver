...
Epsreceive314::Epsreceive314() {}
int32_t Epsreceive314::ID = 0x314;

void Epsreceive314::update_bytes(uint8_t bytes_data[8])
{
  for(uint i=0;i<8;i++)
  {

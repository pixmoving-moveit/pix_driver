...
int32_t Msg101101::ID = 0x101;

// public
Msg101101::Msg101101() { Reset(); }

void Msg101101::UpdateData(double accpedcmd_, bool accctrlena_, double accpedinv_, int accctrlcnt_, int accctrlcks_, bool acctkodis_) {
...
void Msg101101::set_p_accpedcmd(double accpedcmd) {
...
void Msg101101::set_p_accctrlena(bool accctrlena) {
  int x = accctrlena;
  uint8_t a = 0;
...
void Msg101101::set_p_accpedinv(double accpedinv) {
...
void Msg101101::set_p_accctrlcnt(int accctrlcnt) {
...
void Msg101101::set_p_accctrlcks(int accctrlcks) {
...
void Msg101101::set_p_acctkodis(bool acctkodis) {
  int x = acctkodis;
  uint8_t a = 0;
